...
public class MatrixMultiplicationDouble_b {
	public static void main(String[] args) {
        ...
        System.out.println("MatrixMultiplicationDouble_b average execution time: " + averageTime + " milliseconds");
    }
    ...
    // Multiply Matrices with changed loop order for double matrices
