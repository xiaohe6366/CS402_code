...
public class MatrixMultiplicationInt_b {
	// main method
	public static void main(String[] args) {
        ...
        System.out.println("MatrixMultiplicationInt_b average execution time: " + averageTime + " milliseconds");
    }
    ...
    // Multiply Matrices with changed loop order
